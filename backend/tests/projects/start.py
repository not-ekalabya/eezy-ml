...
def stream_start_logs(api_url, project_name, command_id, start_byte=0, poll_seconds=2, timeout_seconds=1800):
    """Stream remote start logs until command completion or server-running hook."""
